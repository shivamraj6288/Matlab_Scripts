...
final_matrix=imread('image_1.png');
...
final_matrix=imread('image_2.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,2)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_3.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,3)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_4.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,4)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_5.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,5)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_6.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,6)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_7.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,7)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_8.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,8)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_9.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,9)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_10.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,10)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_11.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,11)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_12.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,12)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_13.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,13)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_14.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,14)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_15.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
img_as_rows(:,15)=nth_image_avg;
mean_matrix=mean_matrix+nth_image_avg;
final_matrix=imread('image_16.png');
final_matrix=reshape(final_matrix,19200,1);
nth_image_avg=double(final_matrix);
